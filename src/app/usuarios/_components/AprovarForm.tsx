...
import { aprovarUsuario, type ActionState } from "../actions";
...
export function AprovarForm({ nome, email }: Props) {
  const [state, formAction, pending] = useActionState(aprovarUsuario, null);
